import { COMPLETE_EXCHANGE_CHANNEL } from '@shared/channels';
...
import { CompleteChannel } from '../common/CompleteChannel';

export class CompleteExchangeChannel extends CompleteChannel<Exchange> {
  constructor() {
    super({
      name: COMPLETE_EXCHANGE_CHANNEL,
      entity: Exchange,
    });
  }
