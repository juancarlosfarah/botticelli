import { PATCH_ONE_HUMAN_ASSISTANT_CHANNEL } from '@shared/channels';
...
export class PatchOneHumanAssistantChannel extends PatchOneChannel {
  constructor() {
    super({
      name: PATCH_ONE_HUMAN_ASSISTANT_CHANNEL,
  ...
  async handle(
    ...
    // update the agent
    await AppDataSource.manager.update(HumanAssistant, id, {
      description,
      name,
    });
