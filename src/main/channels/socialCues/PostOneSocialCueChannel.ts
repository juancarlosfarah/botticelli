...
export class PostOneSocialCueChannel extends PostOneChannel {
  ...
  async handle(
    ...
    // const socialCueInteractionTemplateRepository = AppDataSource.getRepository(
    //   SocialCueInteractionTemplate,
    // );

    const { description, name, type, formulation } =
      request.params;
    ...
    //   id: In(participants),
    // });
    // socialCue.participants = savedParticipants;

    // save the socialCue with basic properties (name, description, participants)
    ...
    // accumulate socialCue interaction templates to be saved in the database
    // const socialCueInteractionTemplates: SocialCueInteractionTemplate[] = [];
    ...
    //   const socialCueInteractionTemplate = new SocialCueInteractionTemplate();
    //   socialCueInteractionTemplate.order = interactionTemplateIndex;
    ...
    //   });
      ...
      //   socialCueInteractionTemplate.interactionTemplate =
    ...
    //         interaction.socialCue = savedSocialCue;
    ...
    //     }
    //   }
    //   socialCueInteractionTemplate.socialCue = savedSocialCue;
    //   socialCueInteractionTemplates.push(socialCueInteractionTemplate);

    //   // update index
    //   interactionTemplateIndex++;
    // }

    // await socialCueInteractionTemplateRepository.save(
    //   socialCueInteractionTemplates,
    // );
