    ...
    <React.Fragment>
      ...
      >
        ...
        >
            ...
            <tr>
              ...
              >
                <Checkbox
                  ...
                  indeterminate={
                    selected.length > 0 &&
                    selected.length !== interactionTemplates.length
                  }
                  checked={selected.length === interactionTemplates.length}
                  onChange={(event) => {
                    setSelected(
                      event.target.checked
                        ? interactionTemplates.map((row) => row.id)
                        : [],
                    );
                  }}
                  color={
          ...
          <tbody>
            {stableSort(interactionTemplates, getComparator(order, 'id')).map(
              (row) => (
                <tr key={row.id}>
