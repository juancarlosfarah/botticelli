...
import {
  editHumanParticipant,
  fetchAgent,
  selectAgentById,
} from '../../AgentsSlice';

const EditHumanParticipant = (): ReactElement => {
  ...
  const handleEditAgent = async (): Promise<void> => {
    ...
    navigate(`/agents/human/participants/${agentId}`);
  };
  ...
  return (
    <>
      ...
      <Typography level="h2">{t('Edit Human Participant')}</Typography>
      <FormControl>
        <FormControl>
...
export default EditHumanParticipant;
