...
function HumanAssistantTable(): ReactElement {
  ...
  const agents = useSelector(selectHumanAssistants);
                ...
                <td>
                  <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                    <Link
                      ...
                      to={`/agents/human/assistants/${row.id}`}
                    >
                      {t('View')}
                    </Link>
                    <RowMenu
                      ...
                      editPath={`/agents/human/assistants/${row.id}/edit`}
                    />
                  </Box>
                </td>
              </tr>
...
export default HumanAssistantTable;
